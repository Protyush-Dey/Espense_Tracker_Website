...
import PiGraph from "./PiGraph";
import type { SpendWithCatagory } from "../../types/userDataType";
import type { ApiType } from "../../types/api";
import { getSpendWithCatagory } from "../../api/userData.api";



const PiChart = () => {
const { data: userData } = useQuery<ApiType<SpendWithCatagory[]>>({
  queryKey: ["SpendWithCatagory"],
  queryFn: getSpendWithCatagory,
  retry: false,
